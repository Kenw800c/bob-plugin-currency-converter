...
1. 前往本仓库的 [Releases 页面](https://www.google.com/search?q=https://github.com/kenw800c/bob-plugin-currency-converter/releases) 下载最新版的 `CurrencyConverter.bobplugin`。
